<template>
  <material-card class="v-card--material-chart" elevation="0" v-bind="$attrs">
      <template #header>
...
ChartJS.register(Title, Tooltip, Legend, BarElement, PointElement, LineElement, CategoryScale, LinearScale, ArcElement);
